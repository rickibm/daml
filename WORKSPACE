...
GHC_LIB_VERSION = "8.8.0.20190620"

http_archive(
    name = "haskell_ghc__lib__parser",
    build_file = "//3rdparty/haskell:BUILD.ghc-lib-parser",
    sha256 = "d711da091e3b12336c5bb26e8b199371cd28a928d1eb69c6703e5051f345c5e2",
...
hazel_repositories(
    ...
    packages = add_extra_packages(
        extra =
            ...
            hazel_ghclibs(GHC_LIB_VERSION, "d711da091e3b12336c5bb26e8b199371cd28a928d1eb69c6703e5051f345c5e2", "06aaf213d4f8a661ceb9bb073ef14b518869c9d1933df24d5d8638099fc476d5") +
